...
# Aim
To study and implement Pulse Code Modulation (PCM) and Delta Modulation(DC) for signal digitization and transmission, and to observe the reconstructed signal.
# Tools required
1.Google Colab
...
# Output Waveform
## Pulse-Code-Modulation
<img width="1189" height="990" alt="dc_pcm" src="https://github.com/user-attachments/assets/cb0d44fc-48a7-4223-be70-61542d6bd5e3" />

## Delta Modulation
<img width="1203" height="590" alt="dc_deltam" src="https://github.com/user-attachments/assets/29d7038f-cfb4-4afa-af47-6a83c2d4914f" />
